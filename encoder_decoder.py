...
class SimpleEncoderDecoder(nn.Module):
    def __init__(
        self, vocab_size, d_model, num_heads, d_ff, num_encoder_layers, num_decoder_layers, max_len, output_dim, dropout=0.1
    ):
        super(SimpleEncoderDecoder, self).__init__()
        self.encoder = Encoder(
            vocab_size, d_model, num_heads, d_ff, num_encoder_layers, max_len, dropout
        )
        self.decoder = Decoder(
            vocab_size, d_model, num_heads, d_ff, num_decoder_layers, max_len, dropout
        )

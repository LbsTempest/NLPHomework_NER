python main.py --d_model 512 --n_head 4 --n_ffn_layers 2 --n_encoder_layers 4 --n_decoder_layers 4 --dropout 0.2 --batch_size 16 --num_epochs 50 --model_path ./Epoch:0_best_encoder_model.pth
